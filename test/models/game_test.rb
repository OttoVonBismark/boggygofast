...
class GameTest < ActiveSupport::TestCase
  ...
  test "game slug should be present" do
    @game.slug = ""
    refute @game.valid?
  end

  test "game info should have the value specified in setup instead of default" do
    @game.save
    assert_not_equal "A very cool game indeed!", @game.reload.info
    assert_equal "A Super game about Metroid", @game.info
  end 

  test "game slug should be preformatted before saving" do
